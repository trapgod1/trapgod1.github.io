...
<div class="editor-line">  <span class="syntax-field keybind" data-key="ge"><span class="keybind-prefix">g</span>e</span> <span class="syntax-operator">=</span> <span class="syntax-string"><a href="mailto:trapg0d@tutamail.com" target="_blank" class="contact-link">"trapg0d@tutamail.com"</a></span>  <span class="syntax-comment">-- <a href="mailto:trapg0d@tutamail.com" target="_blank" class="contact-link">email</a></span></div>
...
document.addEventListener('keydown', (e) => {
  ...
  if (currentSection === 'contact') {
    const contactLinks = {
      ...
      'e': { url: 'trapg0d@tutamail.com', type: 'email' },
    };
